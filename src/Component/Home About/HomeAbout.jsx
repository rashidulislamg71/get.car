      ...
      <div className={`${styles.homeAbout_container}`}>
        <div className={`${styles.flex} ${styles.homeAbout_inner_content}`}>
          ...
          <div className={`${styles.homeAbout_text}`}>
            ...
            <ul>
              <li>
                <b>Diverse Inventory:</b> Discover a vast selection of vehicles, all
                carefully inspected for quality.
              </li>
              <li>
               <b> Live Bidding Experience:</b> Engage in the excitement of real-time
                auctions, right from the comfort of your home.
              </li>
              <li>
                <b>Complete Transparency:</b> We provide detailed, honest information
                about every vehicle, so you can make an informed decision.
              </li>
              <li>
                <b>Seamless User Experience:</b> Easily navigate through our website
                with an intuitive interface designed for smooth browsing.
              </li>
              <li>
                <b>Secure Transactions:</b> Buy with peace of mind, knowing that your
                personal and financial data are fully protected.
              </li>
            </ul>
